...
!(function (t) {
                        ...
                        (i('0H4L'),
                        {
                            ...
                            submitCaptcha: function () {
                                t('.js-submit-captcha').on(
                                    ...
                                    function (e) {
                                        e.preventDefault()
                                        var i = t('#g-recaptcha-response').val()
                                        if (!i)
                                            return (
                                                r.a.warning(
                    ...
                    var i = 'ThumbnailTouchSwipe.' + e.SliderPro.namespace,
                        s = {
                            ...
                            _onThumbnailTouchStart: function (t) {
                                ...
                                } else this.thumbnailPreviousStartEvent = t.type
                            },
                                    ...
                                    t.on('videoPause.' + i, function () {
                                        ...
                                        s.trigger(i),
                                            e.isFunction(
                                                ...
                                                s.settings.videoPause.call(s, i)
                                    }),
                        ...
                        (o.prototype.play = function () {
                            ...
                            if (!0 === this.ready) this.player.playVideo()
                                ...
                                var e = setInterval(function () {
                                    !0 === t.ready &&
                                        (clearInterval(e), t.player.playVideo())
                                }, 100)
                        }),
    ...
    EVdn: function (t, e, i) {
        ...
        !(function (e, i) {
                ...
                _.extend({
                    ...
                    each: function (t, e) {
                        ...
                        if (C(t))
                            ...
                            for (s in t) if (!1 === e.call(t[s], s, t[s])) break
                        return t
                    },
                ...
                if (((i = i || z), 'string' == typeof t)) {
                    ...
                    if (s[1]) {
                        if (
                            ...
                            for (s in e)
                                v(this[s]) ? this[s](e[s]) : this.attr(s, e[s])
                        return this
                    }
                    return (
                        (n = b.getElementById(s[2])) &&
            ...
            ;(_.Callbacks = function (t) {
                ...
                _.extend({
                        ...
                        var e = [
                            ...
                            n = {
                                ...
                                then: function (t, s, n) {
                                    ...
                                    return _.Deferred(function (i) {
                                        e[0][3].add(
                                            r(0, i, v(n) ? n : R, i.notifyWith)
                                        ),
                                            e[1][3].add(r(0, i, v(t) ? t : R)),
                                            e[2][3].add(r(0, i, v(s) ? s : H))
                                    }).promise()
                                },
                                promise: function (t) {
                    ...
                    when: function (t) {
                        ...
                        if (
                            e <= 1 &&
                            (N(t, o.done(r(i)).resolve, o.reject, !e),
                            'pending' === o.state() || v(n[i] && n[i].then))
                        )
                            return o.then()
                        for (; i--; ) N(n[i], r(i), o.reject)
                        return o.promise()
                    }
                })
            ...
            var B = function (t, e, i, s, n, o, r) {
                    var a = 0,
                        l = t.length,
                        h = null == i
                    if ('object' === S(i))
                        for (a in ((n = !0), i)) B(t, e, a, i[a], !0, o, r)
                    else if (
                        void 0 !== s &&
                        ((n = !0),
                        v(s) || (r = !0),
            ...
            function et (t, e, i) {
                ...
                if (void 0 === i && 1 === t.nodeType)
                    if (
                        ((s = 'data-' + e.replace(tt, '-$&').toLowerCase()),
            ...
            function ct (t, e) {
                for (var i, s, n = [], o = 0, r = t.length; o < r; o++)
                    (s = t[o]).style &&
                        ...
                        e
                            ? ('none' === i &&
                                  ((n[o] = K.get(s, 'display') || null),
                                  n[o] || (s.style.display = '')),
                              '' === s.style.display && lt(s) && (n[o] = ut(s)))
                            : 'none' !== i &&
                              ((n[o] = 'none'), K.set(s, 'display', i)))
                for (o = 0; o < r; o++)
                ...
                return (
                    (i =
                        void 0 !== t.getElementsByTagName
                            ...
                            : []),
                    void 0 === e || (e && I(t, e)) ? _.merge([t], i) : i
                )
            }
            function wt (t, e) {
                for (var i = 0, s = t.length; i < s; i++)
            ...
            function Pt (t, e, i) {
                i
                    ...
                    : void 0 === K.get(t, e) && _.event.add(t, e, Ct)
            }
            ;(_.event = {
                global: {},
                ...
                dispatch: function (t) {
                    ...
                    if (
                        ...
                        for (
                            r = _.event.handlers.call(this, l, h), e = 0;
                            (n = r[e++]) && !l.isPropagationStopped();
                ...
                _.fn.extend({
                    on: function (t, e, i, s) {
                        return Et(this, t, e, i, s)
                    },
                    one: function (t, e, i, s) {
                        return Et(this, t, e, i, s, 1)
                    },
                    off: function (t, e, i) {
                        var s, n
            ...
            function Lt (t, e) {
                ...
                if (1 === e.nodeType) {
                    if (K.hasData(t) && (a = K.get(t).events))
                        for (n in (K.remove(e, 'handle events'), a))
                            for (i = 0, s = a[n].length; i < s; i++)
                                _.event.add(e, n, a[n][i])
                    Z.hasData(t) &&
                        ((o = Z.access(t)), (r = _.extend({}, o)), Z.set(e, r))
                }
            }
            function Mt (t, e) {
                var i = e.nodeName.toLowerCase()
            ...
            function jt (t, e, i, s) {
                ...
                if (
                    ...
                    return t.each(function (n) {
                        var o = t.eq(n)
                        m && (e[0] = f.call(this, n, o.html())), jt(o, e, i, s)
                    })
                if (
                    c &&
                    ((o = (n = St(e, t[0].ownerDocument, !1, t, s)).firstChild),
                    1 === n.childNodes.length && (n = o),
                    o || s)
                ) {
                    for (
                        a = (r = _.map(bt(n, 'script'), Dt)).length;
                        u < c;
                        u++
                    )
                        (h = n),
                    ...
                    if (a)
                        for (
                            ...
                            (h = r[u]),
                                vt.test(h.type || '') &&
                                    !K.access(h, 'globalEval') &&
                                    _.contains(d, h) &&
                                    (h.src &&
                                    'module' !== (h.type || '').toLowerCase()
                                        ? _._evalUrl &&
                                          !h.noModule &&
                                          _._evalUrl(
                                              h.src,
                ...
                function t () {
                    if (d) {
                        ;(h.style.cssText =
                            ...
                            ot.appendChild(h).appendChild(d)
            ...
            function ee (t, e, i, s, n, o) {
                ...
                for (; r < 4; r += 2)
                    'margin' === i && (l += _.css(t, i + nt[r], !0, n)),
                        s
                            ? ('content' === i &&
                                  (l -= _.css(t, 'padding' + nt[r], !0, n)),
                              'margin' !== i &&
                                  (l -= _.css(
                                      t,
                                      'border' + nt[r] + 'Width',
            ...
            function ie (t, e, i) {
                ...
                return (
                    ((!g.boxSizingReliable() && n) ||
                        ...
                        (o = a in t) && (r = t[a])),
                    (r = parseFloat(r) || 0) +
                        ee(t, e, i || (n ? 'border' : 'content'), o, s, r) +
                        'px'
                )
            }
            function se (t, e, i, s, n) {
                return new se.prototype.init(t, e, i, s, n)
            }
            _.extend({
                cssHooks: {
                    opacity: {
                ...
                _.each(['height', 'width'], function (t, e) {
                    _.cssHooks[e] = {
                        get: function (t, i, s) {
                            if (i)
                                return !Kt.test(_.css(t, 'display')) ||
                                    (t.getClientRects().length &&
            ...
            function de (t, e) {
                ...
                for (e = e ? 1 : 0; s < 4; s += 2 - e)
                    n['margin' + (i = nt[s])] = n['padding' + i] = t
                return e && (n.opacity = n.width = t), n
            }
            function ue (t, e, i) {
                for (
                    var s,
                        n = (ce.tweeners[e] || []).concat(ce.tweeners['*']),
                        o = 0,
                        r = n.length;
                    o < r;
                    o++
            ...
            function ce (t, e, i) {
                ...
                for (
                    ...
                    if ((s = ce.prefilters[o].call(h, t, d, h.opts)))
                        return (
                            v(s.stop) &&
                ...
                trigger: function (t, e, s, n) {
                    ...
                    if (
                        ...
                        3 !== s.nodeType &&
                            ...
                            (u = _.event.special[m] || {}),
                            n || !u.trigger || !1 !== u.trigger.apply(s, e)))
                    ) {
                        if (!n && !u.noBubble && !y(s)) {
                            for (
                                l = u.delegateType || m,
                                    xe.test(l + m) || (r = r.parentNode);
                                r;
                                r = r.parentNode
                            )
                                f.push(r), (a = r)
                        ...
                        for (o = 0; (r = f[o++]) && !t.isPropagationStopped(); )
                            (c = r),
                                (t.type = o > 1 ? l : u.bindType || m),
                                (d =
                                    (K.get(r, 'events') || Object.create(null))[
                                        t.type
                                    ] && K.get(r, 'handle')) && d.apply(r, e),
                                (d = h && r[h]) &&
                                    d.apply &&
                                    Y(r) &&
                                    ((t.result = d.apply(r, e)),
                            ...
                            n ||
                                ...
                                (h &&
                                    ...
                                    t.isPropagationStopped() &&
                                        c.addEventListener(m, Se),
                                    s[m](),
                                    t.isPropagationStopped() &&
                                        c.removeEventListener(m, Se),
            ...
            function Ae (t, e, i, s) {
                ...
                else for (n in e) Ae(t + '[' + n + ']', e[n], i, s)
            }
                    ...
                    ajax: function (t, e) {
                        ...
                        function T (t, e, r, l) {
                            ...
                            h ||
                                ...
                                (C.statusText = (e || S) + ''),
                                u
                                    ? g.resolveWith(f, [c, S, C])
                                    : g.rejectWith(f, [C, S, b]),
                                C.statusCode(y),
                                (y = void 0),
                                d &&
            ...
            _.ajaxSetup({
                ...
                jsonpCallback: function () {
                    var t = Ge.pop() || _.expando + '_' + Ce.guid++
                    return (this[t] = !0), t
                }
            }),
                    ...
                    if (a || 'jsonp' === t.dataTypes[0])
                        return (
                            ...
                            (t.converters['script json'] = function () {
                                return r || _.error(n + ' was not called'), r[0]
                            }),
                            (t.dataTypes[0] = 'json'),
                            (o = i[n]),
                            (i[n] = function () {
                ...
                (_.fn.load = function (t, e, i) {
                    var s,
                        ...
                        a = t.indexOf(' ')
                    return (
                        a > -1 && ((s = ve(t.slice(a))), (t = t.slice(0, a))),
                        v(e)
                            ? ((i = e), (e = void 0))
                        ...
                        if (this[0]) {
                            ...
                            if ('fixed' === _.css(s, 'position'))
                                ...
                                t &&
                                    ...
                                    (n.left += _.css(t, 'borderLeftWidth', !0)))
                            }
                            return {
                ...
                _.each(['top', 'left'], function (t, e) {
                    _.cssHooks[e] = Ut(g.pixelPosition, function (t, i) {
                        if (i)
                            return (
                                (i = Vt(t, e)),
                                Ht.test(i) ? _(t).position()[e] + 'px' : i
                            )
                    })
                }),
                ...
                a = {
                    ...
                    maintain: function () {
                        t('.js-maintain', function (t) {
                            return (
                                t.preventDefault(),
                                r.a.warning('Đang phát triển tính năng này'),
                                !1
                            )
                        })
                    },
        ...
        !(function (o, r) {
            ...
            var e = {
                ...
                P = function (t, e) {
                    ...
                    !(function (t, e, i) {
                        C(t, 'load', e), C(t, 'loadeddata', e), C(t, 'error', i)
                    })(t, i, s)
                },
                I = ['IMG', 'IFRAME', 'VIDEO'],
                A = function (e, i, s) {
