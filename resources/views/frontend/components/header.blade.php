...
{{--                <a href="{{ route('get.static.customer_care') }}" title="Chăm sóc khách hàng" rel="nofollow">Chăm sóc khách hàng</a>--}}
                 ...
                 <a href="{{ route('get.product.list') }}">Danh sách sản phẩm</a>
            </div>
            <div class="right">
                @if (Auth::check())
        ...
        <div class="container header-wrapper">
            ...
            <div class="search">
                <form action="{{ $link_search ?? route('get.product.list',['k' => Request::get('k')]) }}" role="search" method="GET">
                    ...
                    <button style="margin: 0px;" type="submit" class="btnSearch">
            ...
            <div class="item">
                <a href="{{ route('get.blog.home') }}" title="Tin Tức" style="color: white;display: flex;align-items: center;">
                    <i class="fa fa-newspaper-o" aria-hidden="true" style="font-size: 28px;margin-right: 8px;">  </i> 
                    <span>   Tin tức</span>
                </a>
            </div>
            <ul class="right">
