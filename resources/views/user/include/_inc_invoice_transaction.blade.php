<div class="wrapper" id="wrapper" style="max-width: 780px;margin: 20px auto;padding: 5px 10px;">
	<div class="" style="display: flex;justify-content: space-between;">
        ...
        <div style="text-align: left">
            <p style="margin: 0"><b>WEB BÁN LAPTOP</b></p>
            <p style="margin: 0">Mã số thuế: <b>0394726213</b></p>
            <p style="margin: 0">Địa chỉ: <b>TP.HCM</b></p>
			<p style="margin: 0">STK: <b>0911000069282</b></p>
            <p style="margin: 0">Điện thoại <b>{{ $transaction->tst_phone }}</b></p>
        </div>
		<a href="" style="width: 48%; display: flex;">
            <img style="background: #2196f3 !important;width: 217px; height: 60px;" src="{{  asset('images/logo.png') }}" alt="Web ban sách">
        </a>
		<div></div>
    </div>
	...
	<div style="">
		...
		<div class="col-5" style="padding-bottom: 100px; width: 50%;float: left;text-align: center">
			...
			<p style="margin: 0"><i>(Ký ghi rõ họ tên)</i></p>
			<span style="margin-top: 50px;display: block"><i>WEB BAN LAPTOP</i></span>
		</div>
