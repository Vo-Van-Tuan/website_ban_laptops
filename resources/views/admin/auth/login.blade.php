    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="/admin-auth/login">Đăng Nhập Hệ Thống Admin</a>
            </div>
            <!-- /.login-logo -->
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-box" style="display: flex;position: relative;align-items: center;">
                            ...
                            <img src="{{ asset('icon/eye_close.png') }}" onclick="handle()" id="eyeicon" style=" width: 30px; position: absolute; right: 10px; ">
                        </div>
                    </div>
                    <div class="row">
                        <!-- /.col -->
