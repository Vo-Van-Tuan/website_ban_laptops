                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $admin->name }}" name="name"  placeholder="NHọ tên">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('phone') ? 'has-error' : '' }}">
                                ...
                                <input type="number" class="form-control" value="{{  $admin->phone }}"  name="phone"  placeholder="Số điện thoại">
