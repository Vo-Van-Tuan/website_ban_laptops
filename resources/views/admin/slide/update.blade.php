                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sd_title') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $slide->sd_title }}" name="sd_title"  placeholder="tên slide">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sd_link') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="sd_link" value="{{ $slide->sd_link}}"  placeholder="Mrlaptop.com">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="box-body block-images">
                                ...
                                <div style="position:relative;"> <a class="btn btn-primary" href="javascript:;"> Chhọn hình ảnh <input type="file" style="position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:&quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=0)&quot;;opacity:0;background-color:transparent;color:transparent;" name="sd_avatar" size="40" class="js-upload"> </a> &nbsp; <span class="label label-info" id="upload-file-info"></span> </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
