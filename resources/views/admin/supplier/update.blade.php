                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sl_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $supplier->sl_name }}" name="sl_name"  placeholder="Tên nhà cung cấp">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sl_phone') ? 'has-error' : '' }}">
                                ...
                                <input type="number" class="form-control" value="{{  $supplier->sl_phone }}"  name="sl_phone"  placeholder="Số điện thoại">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sl_email') ? 'has-error' : '' }}">
                                ...
                                <input type="email" class="form-control" value="{{  $supplier->sl_email }}"  name="sl_email"  placeholder="Địa chỉ Email">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sl_address') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $supplier->sl_address }}" name="sl_address"  placeholder="Địa chỉ">
