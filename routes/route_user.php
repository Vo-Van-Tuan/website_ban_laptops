<?php
    ...
    Route::group(['prefix' => 'account','namespace' => 'User','middleware' => 'check_user_login'], function() {
        ...
        Route::get('update-password','UserPasswordController@updatePassword')->name('get.user.update_pw');
        Route::post('update-password','UserPasswordController@SaveUpdatePassword');
